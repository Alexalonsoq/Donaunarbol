      ...
      <div class="row">
	   ...
	   <ol class="breadcrumb">
		 ...
		 <h3 ><span class="glyphicon glyphicon-edit"></span> Subir imagen</h3>
			...
			<form class="form-horizontal" id="subir" action="insert_emp" method="POST" enctype="multipart/form-data">
				 
			 
			  
			  <div class="form-group">
				<label for="nombre" class="col-sm-3 control-label">Nombre de la empresa</label>
				<div class="col-sm-9">
